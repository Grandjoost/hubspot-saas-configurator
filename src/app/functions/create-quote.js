...
// The block below is auto-generated from src/app/cards/catalog.json by
// scripts/sync-catalog.mjs and ships inline because HubSpot's function
// bundler doesn't include sibling files. Use `npm run upload` (or run the
// script manually) instead of `hs project upload` directly so the inlined
// data stays in lock-step with the canonical JSON.
// CATALOG_START — generated by scripts/sync-catalog.mjs. Edit src/app/cards/catalog.json instead.
const catalog = {
  "currency": "USD",
